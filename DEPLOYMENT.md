...
module.exports = {
  apps: [{
    name: 'chillville-awards-backend',
    script: 'server.js',
    cwd: '/var/www/chillville-awards/server',
    instances: 1,
    exec_mode: 'fork',
    env: {
      NODE_ENV: 'production',
    ...
    error_file: '/var/log/pm2/chillville-backend-error.log',
    out_file: '/var/log/pm2/chillville-backend-out.log',
...
npm install
# Создайте .env файл
pm2 start server.js --name chillville-backend
pm2 save
pm2 startup
